...
@Component({
  selector: 'app-wefabteamsupplier-profile-review',
  standalone: true,
  imports: [
    CommonModule,
    ButtonModule,
  ...
  styleUrls: ['./wefabteamsupplier-profile-review.component.scss']
})
export class WefabteamsupplierProfileReviewComponent implements OnInit {
  ...
  // Loading states
  isLoadingL1: boolean = false;
  isLoadingL2: boolean = false;
  isLoadingL3: boolean = false;
  isLoadingVerification: boolean = false;

  // Error states
  l1Error: boolean = false;
  l2Error: boolean = false;
  l3Error: boolean = false;
